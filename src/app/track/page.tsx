              ...
              <div className="py-6">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-3.5 rounded-xl bg-[#25D366]/[0.06] text-[#25D366] text-xs font-semibold hover:bg-[#25D366]/[0.1] transition-colors"
                  >
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 px-4 py-3.5 rounded-xl bg-red-500/[0.06] text-red-400 text-xs font-semibold hover:bg-red-500/[0.1] transition-colors"
                  >
